...
g = runpy.run_path('/home/user/LOOana/scripts/daily/w0817.py')
...
# ── Shopify 実測: 日別 注文数（ShopifyQL を 2026-08-18 に取得してそのまま貼る） ──
ORD = {
 '完全遮光・形状記憶': {'2026-07-19':15,'2026-07-20':21,'2026-07-21':16,'2026-07-22':24,'2026-07-23':21,
  ...
  '2026-08-11':7,'2026-08-12':3,'2026-08-13':7,'2026-08-14':1,'2026-08-15':2,'2026-08-16':6,'2026-08-17':0},
 '形状記憶日傘': {'2026-07-19':37,'2026-07-20':29,'2026-07-21':32,'2026-07-22':53,'2026-07-23':26,
  ...
  '2026-08-11':14,'2026-08-12':7,'2026-08-13':7,'2026-08-14':9,'2026-08-15':10,'2026-08-16':9,'2026-08-17':9},
}
# ── Meta 実測: 日別 配信指標（8/09-15） ───────────────────────────────
CLK = {
 '完全遮光・形状記憶': {'2026-08-09':392,'2026-08-10':222,'2026-08-11':242,'2026-08-12':127,
  '2026-08-13':163,'2026-08-14':161,'2026-08-15':174,'2026-08-16':215,'2026-08-17':84},
 '形状記憶日傘': {'2026-08-09':455,'2026-08-10':357,'2026-08-11':518,'2026-08-12':342,
  '2026-08-13':385,'2026-08-14':364,'2026-08-15':445,'2026-08-16':406,'2026-08-17':246},
}
META7 = {  # 7日合算（Meta直読）: CPM, link_CTR, CPC(link), Frequency, Reach
 '完全遮光・形状記憶': (4028.8, 0.0446, 90.4, 1.143, 25598),
 '形状記憶日傘':       (3321.9, 0.0381, 87.3, 1.101, 67200),
}
U = ['完全遮光・形状記憶', '形状記憶日傘']
...
print('   3窓（3日 8/15-17 / 5日 8/13-17 / 7日 8/11-17・すべて前日終端）\n')
WINS = [('3日', rng(15, 17)), ('5日', rng(13, 17)), ('7日', rng(11, 17))]
...
for n in U:
    ...
    d7 = rng(11, 17); ck = sum(CLK[n].values()); o = sum(ORD[n][d] for d in d7)

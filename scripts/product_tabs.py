...
COST = {'4-in-1マルチクリーナー':2961,'温感EMSフェイシャルワンド':2079,'ビジュアル耳かき':1655,'3D足臭リセットブラシ':609,'1秒折り畳みチェア':1584,'4WAY':1730,'害虫ブロッカー':867,'形状記憶日傘':1309,'完全遮光・形状記憶':1309,'卓上冷感クーラー':1996,
 ...
 'ナノガラス脱毛パッド':752, '壁掛けディスペンサー':2405, '2WAYシートボックス':1943,'オートソープディスペンサー':3191,'スタイルアップインナー':1202, '快適マジックインソール':677,'むくみ取りかっさ':1149,'スマートノーズEMS美顔器':2453,'ジェットウォッシャー':1259,'ヘアドライタオル':985,'ビジュアル耳かき':1655,'伸縮ガラスクリーナー':1143,'高見えレザーヘッドレストフック':1344,'もちふわ肉球サンダル':1165,'電動温熱カッサ':2533}

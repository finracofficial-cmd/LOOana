# -*- coding: utf-8 -*-
"""[9/20終端の窓ビルダー] 2026-09-21 定例（昨日=9/20 日・連休2日目 実績）。実測のみ・毎回ゼロから積み直す。原価は9/20反映のCJ最新表（再調達原価ベース）。"""
import csv, collections, datetime, json, pickle
AD0920=273661  # キャンペーン合算（アカウント照合 差0円）※翌朝再確認。予算246,000の111%＝日曜上振れ
...
CUM=[d for d in ALLD if d>='2026-09-01']   # 当月累積 = 9月（20日）
assert len(CUM)==20 and CUM[0]=='2026-09-01' and CUM[-1]=='2026-09-20'
...
# 9/20の縦照合（全店1クエリ実測 gross 671,340円 / 値引 20,100円 / 注文135件 / 点数164）

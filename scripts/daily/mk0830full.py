...
NA = [
 ...
 ['⏸ 前倒ししない','快適マジックインソール（3窓すべて目標超え）',
  '3窓とも MER 2.45〜2.83 で目標2.13を超えている。ただし 8/27に22,000→27,000へ増額済みで、'
  '**8/31の増額判定（P2=8/28-30の1日あたり利益 ≥ 28,310円）を宣言済み**。重ねての増額はしない。'
  '⚠️ P2は8/28-29の2日で1日あたり23,280円と基準を下回っており、8/30の出来次第。'
  '本日12:00時点の実売は7,960円と極端に低く、要監視',
  '—','8/31に執行'],
...
JUDGE = [
 ...
 ['8/31','快適マジックインソール 増額判定','P2(8/28-30)の1日あたり利益 ≥ 28,310円',
  'P1(8/24-26・予算22,000) 実売193,826 / 52個 / 広告63,511 / 利益+95,111 = **1日31,704円**。'
  'P2は8/28-29の2日で 実売117,609 / 31個 / 広告50,062 / 利益+46,560 = **1日23,280円**',
  '⚠️ 現時点では基準割れ',
  '8/27は22,000→27,000の変更当日なので両窓から除外。8/30の結果次第。'
  '★「グリーン」全7サイズ在庫0が効いている可能性があるので、判定時に併記する'],

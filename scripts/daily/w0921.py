# -*- coding: utf-8 -*-
"""[9/21終端の窓ビルダー] 2026-09-22 定例（昨日=9/21 月・敬老の日 実績）。実測のみ・毎回ゼロから積み直す。原価は9/20反映のCJ最新表（再調達原価ベース）。"""
import csv, collections, datetime, json, pickle
AD0921=279264  # キャンペーン合算（アカウント照合 差0円）※翌朝再確認。予算256,000の109%＝祝日上振れ
...
CUM=[d for d in ALLD if d>='2026-09-01']   # 当月累積 = 9月（21日）
assert len(CUM)==21 and CUM[0]=='2026-09-01' and CUM[-1]=='2026-09-21'
...
# 9/21の縦照合（全店1クエリ実測 gross 782,020円 / 値引 30,049円 / 注文150件 / 点数190）

# -*- coding: utf-8 -*-
"""[9/17終端の窓ビルダー] 2026-09-18 定例（昨日=9/17 木 実績）。実測のみ・毎回ゼロから積み直す。"""
import csv, collections, datetime, json, pickle
AD0917=245128  # キャンペーン合算（アカウント照合 差0円）※翌朝再確認
...
CUM=[d for d in ALLD if d>='2026-09-01']   # 当月累積 = 9月（17日）
assert len(CUM)==17 and CUM[0]=='2026-09-01' and CUM[-1]=='2026-09-17'
...
# 9/17の縦照合（全店1クエリ実測 gross 506,160円 / 値引 18,412円 / 注文100件 / 点数123）

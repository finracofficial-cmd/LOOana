...
AD0909=239663  # 広告セット合算（アカウント照合 差0円）※翌朝再確認
...
CUM=[d for d in ALLD if d>='2026-09-01']   # 当月累積 = 9月（9日）
assert len(CUM)==9 and CUM[0]=='2026-09-01' and CUM[-1]=='2026-09-09'
...
assert abs(ACCT(D1)-AD0909)<1, ('9/9 広告費 アカウント照合', ACCT(D1))

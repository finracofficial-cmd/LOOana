# -*- coding: utf-8 -*-
"""[9/7終端に固定した窓ビルダー] 2026-09-08 定例（昨日=9/7 月 実績）。実測のみ・毎回ゼロから積み直す。"""
import csv, collections, datetime, json, pickle
AD0907=217183  # 広告セット合算（アカウント照合 差0円）※キャンペーン単位集計は丸めで27円ズレる
...
'2WAYシートボックス':1943,'オートソープディスペンサー':3191,'スタイルアップインナー':1202,'快適マジックインソール':677,'むくみ取りかっさ':1120,'温感EMSフェイシャルワンド':2079,'4-in-1マルチクリーナー':2961,'ヘアドライタオル':985,'1秒折り畳みチェア':1584,'3D足臭リセットブラシ':609,'伸縮ガラスクリーナー':1143}
...
'2WAYシートボックス':4980,'オートソープディスペンサー':7980,'スタイルアップインナー':3980,'快適マジックインソール':3980,'むくみ取りかっさ':3980,'温感EMSフェイシャルワンド':5980,'4-in-1マルチクリーナー':6980,'ヘアドライタオル':3980,'1秒折り畳みチェア':4980,'3D足臭リセットブラシ':3980,'伸縮ガラスクリーナー':3980}
...
CUM=[d for d in ALLD if d>='2026-09-01']   # 当月累積 = 9月（7日）
assert len(CUM)==7 and CUM[0]=='2026-09-01' and CUM[-1]=='2026-09-07'
...
# 9/7の縦照合（全店1クエリ実測 gross 487,840円 / 値引 9,405円 / 注文96件 / 点数108）
assert GROSSD['2026-09-07']==487840 and sum(S[n]['2026-09-07'][1] for n in S if '2026-09-07' in S[n])==9405
assert abs(ACCT(D1)-AD0907)<1, ('9/7 広告費 アカウント照合', ACCT(D1))

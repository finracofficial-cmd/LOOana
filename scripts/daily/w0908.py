...
AD0908=240907  # 広告セット合算（アカウント照合 差0円）※翌朝再確認
...
CUM=[d for d in ALLD if d>='2026-09-01']   # 当月累積 = 9月（8日）
assert len(CUM)==8 and CUM[0]=='2026-09-01' and CUM[-1]=='2026-09-08'
...
assert abs(ACCT(D1)-AD0908)<1, ('9/8 広告費 アカウント照合', ACCT(D1))

...
# ---------- 2 ネクストアクション ----------
NA=[['✅ 判定済','5WAY腰掛けファン','宣言済みトリガーどおり 7,800→5,850（−25%）を実施。Meta直読で daily_budget=5850 を確認。3窓すべて余裕<0.30（−0.41/−0.12/+0.11）・頑健性3端一致','週+約4,500円','完了'],
    ['📌 本日は広告の操作なし','—','判定日の商品はすべて処理済み。次の判定日は8/18（日傘統合・形状記憶−25%・パーカー戻し後の回復）','—','—'],

# -*- coding: utf-8 -*-
"""[8/14終端に固定した窓ビルダー] 2026-08-15 定例（昨日=8/14 金 実績）。実測のみ・毎回ゼロから積み直す。"""
...
# 2026-08-16: Supermetrics復旧により8/15まで揃った。窓は8/15終端。
...
assert len(CUM)==15 and CUM[0]=='2026-08-01' and CUM[-1]=='2026-08-15'
...
assert sum(v[0] for n in S for d in CUM for v in [S[n][d]] if d in S[n])==10296944+926316+704468+676628+605384+798564

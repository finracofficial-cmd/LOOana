# -*- coding: utf-8 -*-
"""[9/19終端の窓ビルダー] 2026-09-20 定例（昨日=9/19 土・楽天マラソン初日 実績）。実測のみ・毎回ゼロから積み直す。"""
import csv, collections, datetime, json, pickle
AD0919=244432  # キャンペーン合算（アカウント照合 差0円）※翌朝再確認
...
CUM=[d for d in ALLD if d>='2026-09-01']   # 当月累積 = 9月（19日）
assert len(CUM)==19 and CUM[0]=='2026-09-01' and CUM[-1]=='2026-09-19'
...
# 9/19の縦照合（全店1クエリ実測 gross 647,460円 / 値引 27,768円 / 注文122件 / 点数158）

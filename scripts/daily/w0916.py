# -*- coding: utf-8 -*-
"""[9/16終端の窓ビルダー] 2026-09-17 定例（昨日=9/16 水 実績）。実測のみ・毎回ゼロから積み直す。"""
import csv, collections, datetime, json, pickle
AD0916=246202  # キャンペーン合算（アカウント照合 差0円）※翌朝再確認
...
CUM=[d for d in ALLD if d>='2026-09-01']   # 当月累積 = 9月（16日）
assert len(CUM)==16 and CUM[0]=='2026-09-01' and CUM[-1]=='2026-09-16'
...
# 9/16の縦照合（全店1クエリ実測 gross 465,530円 / 値引 10,547円 / 注文99件 / 点数114）

...
# 1 全体サマリー
S=[]
for k,lbl,N,K,ACC,days in [('d1','前日 8/06(木)',R['N1'],R['K1'],R['ACCT1'],R['D1']),
    ('d3','3日 8/04-06',R['N3'],R['K3'],R['ACCT3'],R['D3']),
    ('d7','7日 7/31-8/06',R['N7'],R['K7'],R['ACCT7'],R['D7']),
    ('d30','30日 7/08-8/06',R['N30'],R['K30'],R['ACCT30'],R['D30'])]:
...
wb.save('/home/user/LOOana/data/reports/report-2026-08-07.xlsx')

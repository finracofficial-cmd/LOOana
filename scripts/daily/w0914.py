# -*- coding: utf-8 -*-
"""[9/14終端の窓ビルダー] 2026-09-15 定例（昨日=9/14 月 実績）。実測のみ・毎回ゼロから積み直す。"""
import csv, collections, datetime, json, pickle
AD0914=220988  # キャンペーン合算（アカウント照合 差0円）※翌朝再確認
...
CUM=[d for d in ALLD if d>='2026-09-01']   # 当月累積 = 9月（14日）
assert len(CUM)==14 and CUM[0]=='2026-09-01' and CUM[-1]=='2026-09-14'
...
# 9/14の縦照合（全店1クエリ実測 gross 503,580円 / 値引 16,321円 / 注文102件 / 点数121）

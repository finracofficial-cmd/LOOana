# -*- coding: utf-8 -*-
"""[9/01終端に固定した窓ビルダー] 2026-09-02 定例（昨日=9/01 火 実績）。実測のみ・毎回ゼロから積み直す。"""
import csv, collections, datetime, json, pickle
AD0901=230763  # 8/30 広告費（health_check 30日 − CSV 29日 の実測差）
...
D1=ALLD[-1:]; D3=ALLD[-3:]; D7=ALLD[-7:]; D30=[d for d in ALLD if d>='2026-08-03']
...
assert len(CUM)==1 and CUM[0]=='2026-09-01' and CUM[-1]=='2026-09-01'   # 9月に入ったので当月累積は9/01から
...
assert abs(ACCT(D1)-AD0901)<1, ('9/01 広告費 アカウント照合', ACCT(D1))

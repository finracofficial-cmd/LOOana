# -*- coding: utf-8 -*-
"""[9/15終端の窓ビルダー] 2026-09-16 定例（昨日=9/15 火 実績）。実測のみ・毎回ゼロから積み直す。"""
import csv, collections, datetime, json, pickle
AD0915=234391  # キャンペーン合算（アカウント234,409と差18円=0.008%・取得時刻差）※翌朝再確認
...
'2WAYシートボックス':1943,'オートソープディスペンサー':3191,'スタイルアップインナー':1202,'快適マジックインソール':677,'むくみ取りかっさ':1149,'温感EMSフェイシャルワンド':2079,'4-in-1マルチクリーナー':2961,'ヘアドライタオル':985,'1秒折り畳みチェア':1584,'3D足臭リセットブラシ':609,'伸縮ガラスクリーナー':1143,'高見えレザーヘッドレストフック':1344,'もちふわ肉球サンダル':1165,'電動温熱カッサ':2533}
...
CUM=[d for d in ALLD if d>='2026-09-01']   # 当月累積 = 9月（15日）
assert len(CUM)==15 and CUM[0]=='2026-09-01' and CUM[-1]=='2026-09-15'
...
# 9/15の縦照合（全店1クエリ実測 gross 542,580円 / 値引 20,897円 / 注文103件 / 点数133）

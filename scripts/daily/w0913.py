# -*- coding: utf-8 -*-
"""[9/8終端に固定した窓ビルダー] 2026-09-09 定例（昨日=9/8 火 実績）。実測のみ・毎回ゼロから積み直す。"""
import csv, collections, datetime, json, pickle
AD0913=281588  # 広告セット合算（アカウント照合 差0円）※翌朝再確認
...
'2WAYシートボックス':1943,'オートソープディスペンサー':3191,'スタイルアップインナー':1202,'快適マジックインソール':677,'むくみ取りかっさ':1120,'温感EMSフェイシャルワンド':2079,'4-in-1マルチクリーナー':2961,'ヘアドライタオル':985,'1秒折り畳みチェア':1584,'3D足臭リセットブラシ':609,'伸縮ガラスクリーナー':1143,'高見えレザーヘッドレストフック':1344,'もちふわ肉球サンダル':1165}
...
'2WAYシートボックス':4980,'オートソープディスペンサー':7980,'スタイルアップインナー':3980,'快適マジックインソール':3980,'むくみ取りかっさ':3980,'温感EMSフェイシャルワンド':5980,'4-in-1マルチクリーナー':6980,'ヘアドライタオル':3980,'1秒折り畳みチェア':4980,'3D足臭リセットブラシ':3980,'伸縮ガラスクリーナー':3980,'高見えレザーヘッドレストフック':3980,'もちふわ肉球サンダル':3980}
...
CUM=[d for d in ALLD if d>='2026-09-01']   # 当月累積 = 9月（13日）
assert len(CUM)==13 and CUM[0]=='2026-09-01' and CUM[-1]=='2026-09-13'
...
# 9/8の縦照合（全店1クエリ実測 gross 505,590円 / 値引 10,550円 / 注文95件 / 点数110）

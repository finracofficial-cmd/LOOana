...
'スマートノーズEMS美顔器':2453,'W固定スマホ車載ホルダー':1069,'ジェットウォッシャー':1259,'姿勢サポートチェア':1811,
...
END='2026-08-27'; ALLD=[d for d in ALLD if d<=END]
D1=ALLD[-1:]; D3=ALLD[-3:]; D7=ALLD[-7:]; D30=[d for d in ALLD if d>='2026-07-29']
assert D1==['2026-08-27'] and D3[0]=='2026-08-25' and D7[0]=='2026-08-21', (D1,D3[0],D7[0])
assert len(D30)==30 and D30[0]=='2026-07-29', (len(D30),D30[0])
...
assert len(CUM)==27 and CUM[0]=='2026-08-01' and CUM[-1]=='2026-08-27'
...
assert GROSSD['2026-08-27']==670020 and sum(S[n]['2026-08-27'][1] for n in S if '2026-08-27' in S[n])==16328
assert abs(ACCT(D1)-283342)<1, ('8/27 広告費 アカウント照合', ACCT(D1))

...
'害虫ブロッカー':37000,'4WAY':15750,'ムダ毛シェーバー':20000,'偏光・調光サングラス':16500,'5WAY腰掛けファン':16250,
'完全遮光・形状記憶':15750,'2WAYシートボックス':15000,'快適マジックインソール':10000,
'完全遮光・接触冷感UVハット':12000,'姿勢サポートチェア':10000,'接触冷感UVアームカバー':8000,
'卓上冷感クーラー':5000,'バランスケアスリッパ':5000,'携帯電動シェーバー':4000}
...
ALLD=sorted({d for v in S.values() for d in v}); assert ALLD[-1]=='2026-08-12', ALLD[-1]
...
def judge(n):
    ...
    return r,v
TARGETS=['接触冷感UVアームカバー','形状記憶日傘','完全遮光・形状記憶','ムダ毛シェーバー','4WAY','5WAY腰掛けファン',
'偏光・調光サングラス','ナノガラス脱毛パッド','2WAYシートボックス','快適マジックインソール','姿勢サポートチェア',
'害虫ブロッカー','W固定スマホ車載ホルダー','接触冷感UVパーカー','完全遮光・接触冷感UVハット','卓上冷感クーラー',
'バランスケアスリッパ','携帯電動シェーバー']
for n in TARGETS:
    r,v=judge(n)
